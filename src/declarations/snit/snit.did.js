export const idlFactory = ({ IDL }) => {
  ...
  const LevelConfig = IDL.Record({
    'dave_level_multiplier' : IDL.Nat,
    'user_level_multiplier' : IDL.Nat,
    'multiplier_scale' : IDL.Nat,
    'xp_per_level' : IDL.Nat,
    'affinity_multiplier' : IDL.Nat,
    'base_mint_amount' : IDL.Nat,
    'xp_per_burn' : IDL.Nat,
    'xp_per_mint' : IDL.Nat,
  });
  const SnitInitArgs = IDL.Record({ 'level_config' : IDL.Opt(LevelConfig) });
  ...
  const SnitError = IDL.Variant({
    'DavePendingApproval' : IDL.Null,
    'InvalidAmount' : IDL.Null,
    'LinkRequestNotFound' : IDL.Null,
    'TransferError' : IDL.Text,
    'CannotLinkToSelf' : IDL.Null,
    'InsufficientBalance' : IDL.Null,
    'InvalidPrincipal' : IDL.Null,
    'NotAuthorized' : IDL.Null,
    'LinkAlreadyExists' : IDL.Null,
    'DaveNotFound' : IDL.Null,
    'DaveNotActive' : IDL.Null,
    'PrincipalAlreadyLinked' : IDL.Null,
    'DaveAlreadyRegistered' : IDL.Null,
    'UserNotFound' : IDL.Null,
  });
  const SnitResult_1 = IDL.Variant({ 'ok' : IDL.Null, 'err' : SnitError });
  ...
  const DaveStatus = IDL.Variant({
    'Active' : IDL.Null,
    'Suspended' : IDL.Null,
    'Revoked' : IDL.Null,
    'Pending' : IDL.Null,
  });
  const DaveInfo = IDL.Record({
    'status' : DaveStatus,
    'total_snit_burned' : IDL.Nat,
    'principal' : IDL.Principal,
    'name' : IDL.Text,
    'approved_at' : IDL.Opt(IDL.Nat64),
    'description' : IDL.Opt(IDL.Text),
    'level' : IDL.Nat,
    'total_snit_minted' : IDL.Nat,
    'registered_at' : IDL.Nat64,
  });
  const Affinity = IDL.Record({
  ...
  const UserLevel = IDL.Record({
    'level' : IDL.Nat,
    'experience' : IDL.Nat,
    'total_snit_earned' : IDL.Nat,
    'total_snit_spent' : IDL.Nat,
  });
  const Snit = IDL.Service({
    'admin_add_admin' : IDL.Func([IDL.Principal], [SnitResult_1], []),
    'admin_approve_dave' : IDL.Func([IDL.Principal], [SnitResult_1], []),
    'admin_grant_xp' : IDL.Func([IDL.Principal, IDL.Nat], [], []),
    'admin_init' : IDL.Func([], [], []),
    'admin_is_admin' : IDL.Func([IDL.Principal], [IDL.Bool], ['query']),
    'admin_list_admins' : IDL.Func(
        [],
        [
          IDL.Record({
            'owner' : IDL.Principal,
    ...
    'admin_remove_admin' : IDL.Func([IDL.Principal], [SnitResult_1], []),
    'admin_revoke_dave' : IDL.Func([IDL.Principal], [SnitResult_1], []),
    'admin_suspend_dave' : IDL.Func([IDL.Principal], [SnitResult_1], []),
    'admin_update_level_config' : IDL.Func([LevelConfig], [], []),
    'admin_update_owner' : IDL.Func([IDL.Principal], [IDL.Bool], []),
    'burn' : IDL.Func([BurnArgs], [TransferResult], []),
    'confirm_link' : IDL.Func([IDL.Principal], [SnitResult_1], []),
    'dave_register' : IDL.Func(
    ...
    'remove_link' : IDL.Func([IDL.Principal], [SnitResult_1], []),
    'request_link' : IDL.Func([IDL.Principal], [SnitResult_1], []),
    'snit_active_daves' : IDL.Func([], [IDL.Vec(DaveInfo)], ['query']),
    'snit_affinity' : IDL.Func(
        [IDL.Principal, IDL.Principal],
        [IDL.Opt(Affinity)],
        ['query'],
      ),
    'snit_all_daves' : IDL.Func([], [IDL.Vec(DaveInfo)], ['query']),
    'snit_balance' : IDL.Func([IDL.Principal], [IDL.Nat], ['query']),
    'snit_consume_dust' : IDL.Func([IDL.Principal, IDL.Nat], [SnitResult], []),
    'snit_dave_profile' : IDL.Func(
        [IDL.Principal],
        [IDL.Opt(DaveInfo)],
        ['query'],
      ),
    'snit_dust_balance' : IDL.Func(
        [IDL.Principal, IDL.Principal],
        [IDL.Nat],
        ['query'],
      ),
    'snit_level_config' : IDL.Func([], [LevelConfig], ['query']),
    'snit_linked_principals' : IDL.Func(
        [IDL.Principal],
        [IDL.Vec(IDL.Principal)],
        ['query'],
      ),
    'snit_mint' : IDL.Func([IDL.Principal], [TransferResult], []),
    'snit_my_dust' : IDL.Func([IDL.Principal], [IDL.Nat], ['query']),
    'snit_pending_daves' : IDL.Func([], [IDL.Vec(DaveInfo)], ['query']),
    'snit_preview_mint' : IDL.Func(
        [IDL.Principal, IDL.Principal],
        [IDL.Nat],
        ['query'],
      ),
    'snit_purchase' : IDL.Func([PurchaseArgs], [TransferResult], []),
    'snit_resolve_bag' : IDL.Func([IDL.Principal], [IDL.Principal], ['query']),
    'snit_user_affinities' : IDL.Func(
        [IDL.Principal],
        [IDL.Vec(IDL.Tuple(IDL.Principal, Affinity))],
        ['query'],
      ),
    'snit_user_profile' : IDL.Func(
        [IDL.Principal],
        [IDL.Opt(UserLevel)],
        ['query'],
      ),
